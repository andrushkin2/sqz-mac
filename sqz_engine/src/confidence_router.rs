...
mod tests {
    ...
    fn gate_auto_mode_passes_through_default_regardless_of_flag() {
        assert_eq!(
            gate_auto_mode(CompressionMode::Default, false),
            CompressionMode::Default
        );
        assert_eq!(
            gate_auto_mode(CompressionMode::Default, true),
            CompressionMode::Default
        );
    }
    ...
    fn gate_auto_mode_passes_through_safe_regardless_of_flag() {
        assert_eq!(
            gate_auto_mode(CompressionMode::Safe, false),
            CompressionMode::Safe
        );
        assert_eq!(
            gate_auto_mode(CompressionMode::Safe, true),
            CompressionMode::Safe
        );
    }
}
